...
public class MovementJoystick : MonoBehaviour
{
    ...
    public void Drag(BaseEventData eventData)
    {
        ...
        Vector3 direction = Vector3.Normalize(touchPos - _initPos);
        float distance = Vector3.Distance(touchPos, _initPos);
        direction = CalcStickDirection(direction);
        _stick.position = _initPos + (direction * _radius);
    }
